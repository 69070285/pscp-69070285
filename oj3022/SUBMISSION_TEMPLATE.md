...
```text
This is the simple testcase that doesn't have in sample testcases
```
...
```text
This is the case that both unit are the same
```
...
```text
This is the case that first unit is F,K,R and second unit is celsius (C)
```
