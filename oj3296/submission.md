...
Constraints:
The mixed color can be found by calculating the average of the first and second RGB colors; division will yield an integer result.
```
...
```text
Step 1: Input the first RGB color and the second RGB color.
Step 2: Calculate the mixed RGB color by taking the average.
Step 3: Output the mixed RGB color.
```
...
```text
This is the case where all the RGB values of the first color are 0.
```
...
```text
This is the case where all the RGB values of the second color are 0.
```
...
```text
This is the case where both colors have RGB values.
```
